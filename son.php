...
if (isset($_POST['LOGIN'])) {
     ...
     $getuserdata = file_get_contents("export.json");
     $json = json_decode($getuserdata);

     foreach ($json as $key) {
          if ($username === $key->firstname && $password === $key->password) {
...
<body>
     ...
     if (isset($_POST["submit"])) {
          if (empty($_POST["firstname"])) {
               ...
               if (file_exists('export.json')) {
                    $current_data = file_get_contents('export.json');
                    ...
                    if (file_put_contents('export.json', $final_data)) {
